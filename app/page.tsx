...
export default function Home() {
  ...
  return (
    <section className="min-h-screen w-screen flex flex-col items-center justify-center px-5 absolute inset-0 -z-10 bg-white [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#63e_100%)]">
      ...
      <h1 className="text-4xl font-bold mb-7">Available for work DM now.</h1>
      <Card className="max-w-[500px] w-full">
        <Tabs defaultValue="sales">
          <CardContent className="mt-5">
            <TabsList className="grid grid-cols-2 mb-4">
              <TabsTrigger value="sales">Ping me for new project</TabsTrigger>
              <TabsTrigger value="support">Support Project</TabsTrigger>
            </TabsList>
